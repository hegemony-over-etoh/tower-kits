...
local ACTIVE_KEY = "FallingPlatformActive"
...
function FallingPlatform.Run(scope: _T.Scope, utility: _T.Utility)
	...
	local function activate(activeTime: number)
		...
		for _, part in partTable do
			...
			setInstanceActive(scope, part.part, ACTIVE_KEY, false)
		end
		...
		for _, part in partTable do
			...
			setInstanceActive(scope, part.part, ACTIVE_KEY, true)
		end
