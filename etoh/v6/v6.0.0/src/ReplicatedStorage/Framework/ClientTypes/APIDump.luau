-- API instance property dump as of 29/06/25 (DD/MM/YY)
...
export type AudioSpeechToText=Instance&{Enabled:boolean?,Text:string?,}
...
export type ScrollingFrame=GuiObject&{AutomaticCanvasSize:Enum.AutomaticSize?,BottomImage:string?,BottomImageContent:string?,CanvasPosition:Vector2?,CanvasSize:UDim2?,ElasticBehavior:Enum.ElasticBehavior?,HorizontalScrollBarInset:Enum.ScrollBarInset?,MidImage:string?,MidImageContent:string?,ScrollBarImageColor3:Color3?,ScrollBarImageTransparency:number?,ScrollBarThickness:number?,ScrollingDirection:Enum.ScrollingDirection?,ScrollingEnabled:boolean?,TopImage:string?,TopImageContent:string?,VerticalScrollBarInset:Enum.ScrollBarInset?,VerticalScrollBarPosition:Enum.VerticalScrollBarPosition?,}
...
export type HandRigDescription=Instance&{Index1:Instance?,Index1TposeAdjustment:CFrame?,Index2:Instance?,Index2TposeAdjustment:CFrame?,Index3:Instance?,Index3TposeAdjustment:CFrame?,IndexRange:Vector3?,IndexSize:number?,Middle1:Instance?,Middle1TposeAdjustment:CFrame?,Middle2:Instance?,Middle2TposeAdjustment:CFrame?,Middle3:Instance?,Middle3TposeAdjustment:CFrame?,MiddleRange:Vector3?,MiddleSize:number?,Pinky1:Instance?,Pinky1TposeAdjustment:CFrame?,Pinky2:Instance?,Pinky2TposeAdjustment:CFrame?,Pinky3:Instance?,Pinky3TposeAdjustment:CFrame?,PinkyRange:Vector3?,PinkySize:number?,Ring1:Instance?,Ring1TposeAdjustment:CFrame?,Ring2:Instance?,Ring2TposeAdjustment:CFrame?,Ring3:Instance?,Ring3TposeAdjustment:CFrame?,RingRange:Vector3?,RingSize:number?,Side:Enum.HandRigDescriptionSide?,Thumb1:Instance?,Thumb1TposeAdjustment:CFrame?,Thumb2:Instance?,Thumb2TposeAdjustment:CFrame?,Thumb3:Instance?,Thumb3TposeAdjustment:CFrame?,ThumbRange:Vector3?,ThumbSize:number?,}
...
export type InputBinding=Instance&{Backward:Enum.KeyCode?,Down:Enum.KeyCode?,Forward:Enum.KeyCode?,KeyCode:Enum.KeyCode?,Left:Enum.KeyCode?,PressedThreshold:number?,ReleasedThreshold:number?,Right:Enum.KeyCode?,Scale:number?,UIButton:GuiButton?,Up:Enum.KeyCode?,Vector2Scale:Vector2?,}
...
export type UIContainerQuery=UIComponent&{Active:boolean?,AspectRatioRange:NumberRange?,MaxSize:Vector2?,MinSize:Vector2?,}
